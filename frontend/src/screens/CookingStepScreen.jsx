...
import RecipeStepPlayer from "../components/RecipeStepPlayer";
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.stepContainer}>
          ...
          <RecipeStepPlayer stepText={steps[currentStepIndex]} />
        </View>
        ...
        <View style={styles.tipsContainer}>
          ...
          <View style={styles.tipCard}>
            <Text style={styles.tipText}>
              {currentStepIndex === 0 &&
                "Start by reading through all steps before beginning."}
              {currentStepIndex === 1 &&
                "Keep your ingredients organized and within reach."}
